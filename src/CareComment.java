...
public class CareComment extends JFrame {
    ...
    public CareComment() {
        ...
        try (Connection connection = DriverManager.getConnection(DB_URL, USER, PASSWORD);
             ...
             ResultSet resultSet = statement.executeQuery("SELECT username, comment, updated_at FROM care_comments ORDER BY created_at DESC")) {
            ...
            while (resultSet.next()) {
                ...
                comments.append(username).append(": ").append(comment).append(" (Updated at: ").append(updatedAt).append(")\n\n");
            }

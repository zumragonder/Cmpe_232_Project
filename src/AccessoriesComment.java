...
public class AccessoriesComment extends JFrame {
    private static final String DB_URL = "jdbc:mysql://localhost:3306/trendyol_db";
    private static final String USER = "root";
    private static final String PASSWORD = "Eren.2011";

    public AccessoriesComment() {
        // Set window title
        ...
        try (Connection connection = DriverManager.getConnection(DB_URL, USER, PASSWORD);
             ...
             ResultSet resultSet = statement.executeQuery("SELECT username, comment FROM accessories_comments ORDER BY created_at DESC")) {

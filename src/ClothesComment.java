...
public class ClothesComment extends JFrame {
    ...
    public ClothesComment() {
        ...
        try (Connection connection = DriverManager.getConnection(DB_URL, USER, PASSWORD);
             ...
             ResultSet resultSet = statement.executeQuery("SELECT username, comment FROM clothes_comments ORDER BY created_at DESC")) {
